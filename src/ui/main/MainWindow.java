...
public class MainWindow extends JFrame {
	...
	private JPanel pnColectivosA�adir;
	private JComboBox<Integer> cbColectivosA�adir;
	private JButton btnA�adirColectivo;
	private JPanel panel;
	private Precio_Colectivos colectivos_Precios;
	private JPanel pnPrecioA�adirColectivo;
	private JTextField txPrecioA�adirColectivo;
	private JLabel lbPrecioA�adirColectivo;
			...
			btnCrearCursoCrear.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(colectivos_Precios.size()==0) {
						JOptionPane.showMessageDialog(pnCrearCurso,"Es necesario a�adir precios de curso para algun colectivo");
						return;
					}
...
//				"Seleccione un colegiado de la lista y, si tiene titulación, se procederá a darle de alta en el COIIPA");
	...
	private JPanel getPnColectivosCenter() {
		if (pnColectivosCenter == null) {
			...
			pnColectivosCenter.add(getPnColectivosA�adir(), BorderLayout.NORTH);
	...
	private JPanel getPnColectivosA�adir() {
		if (pnColectivosA�adir == null) {
			pnColectivosA�adir = new JPanel();
			FlowLayout flowLayout = (FlowLayout) pnColectivosA�adir.getLayout();
			flowLayout.setAlignment(FlowLayout.LEFT);
			pnColectivosA�adir.add(getCbColectivosA�adir());
			pnColectivosA�adir.add(getPnPrecioA�adirColectivo());
			pnColectivosA�adir.add(getBtnA�adirColectivo());
		}
		return pnColectivosA�adir;
	}
	private JComboBox<Integer> getCbColectivosA�adir() {
		if (cbColectivosA�adir == null) {
			cbColectivosA�adir = new JComboBox();
			cbColectivosA�adir.setFont(new Font("Tahoma", Font.PLAIN, 16));
			cbColectivosA�adir.setModel(new DefaultComboBoxModel(new String[] {"Colegiado", "Precolegiado", "Estudiante", "Desempleado", "Otros", "Todos"}));
			cbColectivosA�adir.setAlignmentX(0.0f);
		}
		return cbColectivosA�adir;
	}
	private JButton getBtnA�adirColectivo() {
		if (btnA�adirColectivo == null) {
			btnA�adirColectivo = new JButton("A\u00F1adir");
			btnA�adirColectivo.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if(colectivos_Precios==null) {
						colectivos_Precios = new Precio_Colectivos();
					}
					if(txPrecioA�adirColectivo.getText().isEmpty()) {
						JOptionPane.showMessageDialog(pnCrearCurso, "Es necesario introducir un precio");
						return;
					}
					try {
						double precio = Double.valueOf(txPrecioA�adirColectivo.getText());
						String colectivo = (String) cbColectivosA�adir.getSelectedItem();
						if(precio < 0) {
							JOptionPane.showMessageDialog(pnCrearCurso, "No se puede a�adir un precio negativo");
							return;
						}
						if(colectivos_Precios.containsColectivo(colectivo)) {
							JOptionPane.showMessageDialog(pnCrearCurso, "No se puede a�adir porque el colectivo ya ha sido a�adido");
							return;
						}
						if(colectivo.equals("Todos")) {
							if(colectivos_Precios.size()!=0) {
								JOptionPane.showMessageDialog(pnCrearCurso, "No se puede a�adir un precio para todos porque hay precios para otros colectivos");
								return;
							}
							...
							if(colectivos_Precios.containsColectivo("Todos")) {
								JOptionPane.showMessageDialog(pnCrearCurso, "No se puede a�adir un precio para el colectivo seleccionado porque hay un precio para todos");
								return;
							}
							else {
								colectivos_Precios.add(colectivo, precio);
			...
			btnA�adirColectivo.setFont(new Font("Tahoma", Font.PLAIN, 16));
		}
		return btnA�adirColectivo;
	}
	...
	private JPanel getPnPrecioA�adirColectivo() {
		if (pnPrecioA�adirColectivo == null) {
			pnPrecioA�adirColectivo = new JPanel();
			pnPrecioA�adirColectivo.setLayout(new BorderLayout(0, 0));
			pnPrecioA�adirColectivo.add(getTxPrecioA�adirColectivo());
			pnPrecioA�adirColectivo.add(getLbPrecioA�adirColectivo(), BorderLayout.NORTH);
		}
		return pnPrecioA�adirColectivo;
	}
	private JTextField getTxPrecioA�adirColectivo() {
		if (txPrecioA�adirColectivo == null) {
			txPrecioA�adirColectivo = new JTextField();
			txPrecioA�adirColectivo.setFont(new Font("Tahoma", Font.PLAIN, 16));
			txPrecioA�adirColectivo.setColumns(10);
		}
		return txPrecioA�adirColectivo;
	}
	private JLabel getLbPrecioA�adirColectivo() {
		if (lbPrecioA�adirColectivo == null) {
			lbPrecioA�adirColectivo = new JLabel("Precio:");
			lbPrecioA�adirColectivo.setFont(new Font("Tahoma", Font.PLAIN, 14));
		}
		return lbPrecioA�adirColectivo;
	}
}